	...
	public ArrayList<Node> Expand2(Node n) {
		...
		for (int i = 0; i < this.operators.length; i++) {
			if (this.operators[i].equals("North")) {
				if (n.state.JonC - 1 >= 0 && gridOfNode[n.state.JonR][n.state.JonC - 1] == 'D') {
					...
					if (n.state.JonC - 1 >= 0 && gridOfNode[n.state.JonR][n.state.JonC - 1] != 'O'
			...
			if (this.operators[i].equals("South")) {
				if (n.state.JonC + 1 < gridOfNode[0].length && gridOfNode[n.state.JonR][n.state.JonC + 1] == 'D') {
					State newState = n.state.clone();
					char[][] gridOfClonedNode = gridFromBitField(newState.row, newState.column, newState.grid);
					...
					if (n.state.JonC + 1 < gridOfNode[0].length && gridOfNode[n.state.JonR][n.state.JonC + 1] != 'O'
							&& gridOfNode[n.state.JonR][n.state.JonC + 1] != 'W') {
			...
			if (this.operators[i].equals("East")) {
				...
				if (n.state.JonR + 1 < gridOfNode.length && gridOfNode[n.state.JonR + 1][n.state.JonC] == 'D') {
					State newState = n.state.clone();
					char[][] gridOfClonedNode = gridFromBitField(newState.row, newState.column, newState.grid);
					...
					if (n.state.JonR + 1 < gridOfNode.length && gridOfNode[n.state.JonR + 1][n.state.JonC] != 'O'
			...
			if (this.operators[i].equals("West")) {
				...
				if (n.state.JonR - 1 >= 0 && gridOfNode[n.state.JonR - 1][n.state.JonC] == 'D') {
					State newState = n.state.clone();
					char[][] gridOfClonedNode = gridFromBitField(newState.row, newState.column, newState.grid);
					gridOfClonedNode[n.state.JonR - 1][n.state.JonC] = 'J';
					if (n.parentNode != null) {
					...
					if (n.state.JonR - 1 >= 0 && gridOfNode[n.state.JonR - 1][n.state.JonC] != 'O'
							&& gridOfNode[n.state.JonR - 1][n.state.JonC] != 'W') {
						State newState = n.state.clone();
						char[][] gridOfClonedNode = gridFromBitField(newState.row, newState.column, newState.grid);
			...
			if (this.operators[i].equals("Kill")) {
				...
				if (newState.numberOfDragonGlassPieces > 0) {
					...
					if (n.state.JonR + 1 < gridOfNode[0].length && gridOfNode[n.state.JonR][n.state.JonC + 1] == 'W') {
						gridOfClonedNode[n.state.JonR][n.state.JonC + 1] = '.';
					}
					newState.grid = BitFieldFromgrid(gridOfClonedNode);
...
//		for (int i = 0; i < clonedGrid.length; i++) {
//			for (int j = 0; j < clonedGrid.length; j++) {
//				if (clonedGrid[i][j] != goalGrid[i][j]
//						&& clonedGrid[i][j] != 'J' && goalGrid[i][j] != 'J') {
//					return false;
//				}
//			}
//		}
