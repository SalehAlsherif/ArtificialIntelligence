		...
		for (int i = 0; i < this.operators.length; i++) {
			if (this.operators[i].equals("North")) {
				...
				if (n.state.JonC - 1 >= 0
					...
					char[][] newStateGrid = n.state.grid.clone();
					newStateGrid[n.state.JonR][n.state.JonC - 1] = 'J';
					if (n.parentNode.state.grid[n.state.JonR][n.state.JonC] == 'D')
						newStateGrid[n.state.JonR][n.state.JonC] = 'D';
					else
						newStateGrid[n.state.JonR][n.state.JonC] = '.';
					State newState = new State(newStateGrid);
			...
			if (this.operators[i].equals("East")) {
				...
				if (n.state.JonR + 1 < n.state.grid.length
					...
					char[][] newStateGrid = n.state.grid.clone();
					newStateGrid[n.state.JonR + 1][n.state.JonC] = 'J';
					if (n.parentNode.state.grid[n.state.JonR][n.state.JonC] == 'D')
						newStateGrid[n.state.JonR][n.state.JonC] = 'D';
					else
						newStateGrid[n.state.JonR][n.state.JonC] = '.';
			...
			if (this.operators[i].equals("Kill")) {
				...
				if (n.state.JonR - 1 >= 0
						&& n.state.grid[n.state.JonR - 1][n.state.JonC] == 'W') {
					newStateGrid[n.state.JonR - 1][n.state.JonC] = '.';
				}
				if (n.state.JonR + 1 < n.state.grid.length
						&& n.state.grid[n.state.JonR + 1][n.state.JonC] == 'W') {
					n.state.grid[n.state.JonR + 1][n.state.JonC] = '.';
				}
				if (n.state.JonC - 1 >= 0
						&& n.state.grid[n.state.JonR][n.state.JonC - 1] == 'W') {
					n.state.grid[n.state.JonR][n.state.JonC - 1] = '.';
				}
